...
public class CameraController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        for (int i = 0; i < CinemachineMixingCamera.ChildCameras.Count; i++)
        {
    ...
    [System.Serializable]
    public class VirtualCameraMapping
    {
        public Transform CharacterWaypoint;
        public CinemachineVirtualCameraBase Vcam;
        public bool LookAtPlayerCharacter = false;
        
        public float DistanceToPlayer 
        { 
            get 
            { 
                Transform player = FindFirstObjectByType<NavMeshAgentController>()?.transform;
                return player != null ? Vector3.Distance(CharacterWaypoint.position, player.position) : 0f;
            } 
        }
        
        public bool IsValid()
        {
            return CharacterWaypoint != null && Vcam != null;
        }
        
        public float GetDistance(Vector3 playerPosition)
        {
            return Vector3.Distance(CharacterWaypoint.position, playerPosition);
        }
    }
    ...
    public class CharacterCameraData
    {
        ...
        public ConversationCameraDistanceSettings SpeakerCameraSettings;
    }

    [System.Serializable]
    public class ConversationCameraDistanceSettings
    {
        public float LateralDistance = 2f;
        public float Height = 1.5f;
        public float OverShoulderDistance = 1f;
    }
}
